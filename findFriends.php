<?php
	...
	$read = "SELECT * FROM AC_Users WHERE userType='Student' AND NOT userid = '$dynamicUserID'";
								...
								<div class='col-2 text-center'>
									<div class='indexOptionStu'>
										...
										<form action='reqSpecFriend.php' method='POST' enctype='multipart/form-data'>
												...
												<button type='submit' name='submitBtnView' class='btn btn-info btnPadding'><i class='far fa-paper-plane'></i></button></form>
										</form>
								</div>
