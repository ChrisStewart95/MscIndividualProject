...
<body id="baseBackground">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-6">
				<a href="findFriends.php">
					<div class="indexOption menuHover">
							<img src="../imgs/sendRequest.jpeg" class='menuImg'>
							<div class="menuText">
								<h2><strong>Send A Request</strong></h2>
								<br>
								<h5><em>Search for and add new friends</em></h5>
							</div>	
					</div>
				</a>
			</div>
			...
			<div class="col-6">
				<a href="viewFriendRequests.php">
					<div class="indexOption menuHover">
						<img src="../imgs/requests.jpeg" class='menuImg'>
							<div class="menuText">
								<h2><strong>View Recieved Requests</strong></h2>
								<br>
								<h5><em>Accept or decline requests made by other members</em></h5>
							</div>
					</div>
				</a>
			</div>
