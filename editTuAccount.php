...
<body id="baseBackground">
	...
	<div class="container-fluid">
		<div class="row" id="banner">
			...
			<div class="col-1 btnCenter">
				<a class="btn btn-light" href="tutorBio.php"><strong>Back</strong></a>
			</div>
	...
	<div class="container" id="formWidth">
		<div class="row paddingTop">
			...
			<form action = 'editTuAccount.php' method='POST' enctype='multipart/form-data'>
...
<?php
	...
	if(isset($_POST['submitBtn'])){
		...
		if($filetype == 'image/jpeg'){
			...
			// Uploading the imagefile to the img/ folder on filezilla
