<?php
	...
	if(isset($_POST['submitBtnAccept'])){
			...
			// Create the new relationship in the AC_Friends table
			$createRelationship = "INSERT INTO AC_Friends (studentOneID, studentTwoID) VALUES ('$dynamicUserID', '$indStuID')";
			...
			// Delete from the FriendRequests table the request sent by the requester
			$destroyRequest = "DELETE FROM AC_FriendRequests WHERE requesterID = '$indStuID' AND requesteeID = '$dynamicUserID'";
	...
	$read = "SELECT * FROM AC_FriendRequests WHERE requesteeID='$dynamicUserID'";
	...
	<div class="container-fluid">
		<div class="row" id="banner">
			...
			<div class="col-1 btnCenter">
				<a class="btn btn-light" href="myFriends.php"><strong>Friends</strong></a>
			</div>
				...
				while($row = $result->fetch_assoc()){
					...
					while ($row2 = $resultStuDetails->fetch_assoc()){
						...
						echo 	"<div class='col-4 text-center'>
									...
									<form action='viewFriendRequests.php' method='POST' enctype='multipart/form-data'>
										...
										<button type='submit' name='submitBtnDecline' class='btn btn-warning'><i class='fas fa-times'></i></button>
									</form>
