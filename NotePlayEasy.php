...
<body id="baseBackground">
	...
	<div class="container-fluid">
		<div class="row rowPad">
			...
			<div class="col-12 text-center">
				...
				<button class="btn btn-secondary btnCenter" id="btnStartEasy" disabled onclick="playGameEasy()">Start NotePlay!</button>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row rowPad">
			<div class="col-12 text-center">
				<?php
					$stringSelection = $_POST['string'];

					if (isset($_POST['string'])) {

					} else {
						header('Location: chooseString.php');
					}
	...
	<script>
		var stringSelected = '<?php echo $stringSelection; ?>';
